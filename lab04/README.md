...
- Установлен Git
- Рабочая директория: `C:\Users\jenia\Desktop\AS_Croitor\lab04`
...
> **Важно:** приватный ключ не хранить в публичном репозитории. В учебных целях ключы лежали локально.

---

# Пошаговое выполнение (что я делал)
...
## Шаг 2 — Подготовил `docker-compose.yml` (контроллер + агент)
Файл `docker-compose.yml` (упрощённый, рабочий пример):
```yaml
version: "3.8"
